...
function sum(a, b) { //eslint-disable-line
    let result = a + b;
    let msg = 'The sum of ' + a + ' and ' + b + ' is ' + result +'.';
    return [result , msg];
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    result = sum(result[0],sumArr[2]);
    let msg = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${result[0]} is their sum.`;
    return [result[0],msg];
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    let msg = `The numbers ${dynamicArray} have a product of ${result}.`;
